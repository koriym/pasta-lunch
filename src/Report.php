...
.meta{color:var(--color-text-muted);font-size:12px;margin-top:4px}
.view-toggle{display:flex;gap:8px;margin-bottom:16px}
.view-btn{padding:6px 16px;border:1px solid var(--color-border);border-radius:6px;background:var(--color-bg);cursor:pointer;font-size:14px;transition:all 0.2s}
.view-btn:hover{background:var(--color-bg-secondary)}
.view-btn.active{background:var(--color-link);color:#fff;border-color:var(--color-link)}
...
.issue-type-name{font-weight:600;font-size:1.1em}
.issue-type-name a{color:var(--color-link);text-decoration:none}
.issue-type-name a:hover{text-decoration:underline}
.issue-count{background:var(--color-bg-secondary);padding:2px 8px;border-radius:10px;font-size:12px}
.file-item{display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid var(--color-bg-secondary);font-family:monospace;font-size:13px}
.file-item:last-child{border-bottom:none}
.file-item-path{color:var(--color-text)}
.file-item-value{color:var(--color-mamma-mia);font-weight:500}
CSS;
